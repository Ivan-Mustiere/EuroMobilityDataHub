...
Usage : python apps/pipeline/run.py [--env preprod|prod]
Si --env est omis, la valeur vient de APP_ENV dans .env (défaut : preprod).
"""
...
if __name__ == "__main__":
    ...
    env = args.env or os.getenv("APP_ENV", "preprod")
